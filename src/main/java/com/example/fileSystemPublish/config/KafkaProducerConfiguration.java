...
public class KafkaProducerConfiguration {
    ...
    @Bean
    public ProducerFactory<String, FileInformation> producerFactory(){
        return new DefaultKafkaProducerFactory<>(producerConfig());
    }
    @Bean
    public KafkaTemplate<String, FileInformation> kafkaTemplate(
            ProducerFactory<String, FileInformation> producerFactory
    ){
